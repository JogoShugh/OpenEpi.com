...
var Title="Power for Cross-Sectional Studies";
...
var Description=
"This module estimates power for Cross-Sectional studies. Entering sample size in exposed and non-exposed groups, prevalence(%) of disease or coverage among exposed and non-exposed, and the desired confidence interval will calculate the power with and without the continuity correction.";
...
var Demo="An example is provided by a hypothetical cross-sectional study comparing the prevalence of hypercholesterolemia between current cigarette smokers and non-smokers. Hypercholesterolemia is defined as >200 mg% from serum of fasting blood sample. Assume 70 subjects were recruited into each group during a particular week of study period. From the blood samples, it was observed that hypercholesterolemia was observed in 30% of smokers and 10% of non-smokers. How much power does such a study have to detect a significant difference at the significance level of 0.05 (95% confidence level)?"+
	  "<ul>"+
		...
		"<li>In the new window screen, the power with and without the continuity correction will be seen as 78.94% and 84.87%, respectively.</li>"+
      "</ul>";
...
// 	normal approximation method; n1,p1=cases and n2,p2=control;
	var dif=0; var q1=0; var q2=0; var d=0; var pbar=0; var qbar=0; var powerz=0; var powerzcc=0; var rr=0; var ratio=0; 
	var ratio=n2/n1;
	var rr=p1/p2;
	var dif=pp1-pp2;
	var q1=1-p1;
...
with (outTable)
	...
	newrow("color#66ffff:span4:bold:l:Prevalence/Coverage among Exposed (%)",		"color#ffff99:span4:c:"+pp1),
	newrow("color#66ffff:span4:bold:l:Number of Non-exposed",						"color#ffff99:span4:c:"+fmtSigFig(n2,6));
	newrow("color#66ffff:span4:bold:l:Prevalence/Coverage among Non-exposed (%)",	"color#ffff99:span4:c:"+pp2);
	newrow("color#66ffff:span4:bold:l:Prevalence/Coverage Ratio",				"color#ffff99:span4:c:"+fmtSigFig(rr,2));
	newrow("color#66ffff:span4:bold:l:Prevalence Difference (%)<sup>1",				"color#ffff99:span4:c:"+dif);
	line(8);
	...
	line(8);
	newrow("span8:l:<sup>1</sup><small> Prevalence Difference = Prevalence in Exposed - Prevalence in Non-exposed.");
	endtable();
	}  
} 
