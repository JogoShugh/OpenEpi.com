     ...
     if(/\bdata\.\w*/.test(strItem))
             {
              ...
              strItem="data";
            //  alert(658 + dataNames[dataNames.length-1]);
             }
		  ...
		  if (this.mode=="input")
		        {
				 ...
				 if (/\bdata\b/.test(strItem)||
                  ...
                  /\bcalendar\b/i.test(strItem)||
                  /\btext\b/i.test(strItem)||
                  /\blinedata\b/i.test(strItem)||
				  /\blabel\b/i.test(strItem))
				  {
					...
					//strArray[i]="";
      //    alert(this.precmds[this.precmds.length])
					strItem="";
