...
{
  fe+= '<br/><image name="inputscreen" width="90%" alt="Input screen image"  src="'+inscreenimg+'" border="0">'
}
...
if (outscreenimg.length>0)
     {
      fe+= '<div id="outimg" style="text-align:center;"><p></p><image id="outputscreen" name="outputscreen" alt="Output screen image"  width="90%"  src="'+outscreenimg+'"  border="1"><p></p></div>'
	 }
/*
