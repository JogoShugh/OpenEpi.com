...
if (!regexp.test(stringtofix))
{
	...
	stringtofix+="\n<br>"+t("Print from the browser, or select all or part of the text and then copy and paste to other programs.")+"<p></p>\n";
...
fe+='<table width="100%" position:relative; border="0" cellspacing="0" cellpadding="4" bgcolor="#CCCCCC">';
fe+='  <tr color="#FFFFFF">';
...
if (outscreenimg.length>0)
     {
      fe+= '<div id="outimg" style="text-align:center;"><p></p><image id="outputscreen" name="outputscreen" alt="Output screen image" src="'+outscreenimg+'"  border="1"><p></p></div>'
	 }
/*
