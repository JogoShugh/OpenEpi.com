...
htmlstr+='<font size=-1><br>&nbsp;Conf. level<br>&nbsp;&nbsp;&nbsp;\='+ConfLevel+'\%</font>';

htmlstr+='</span><p></p>';
/*
htmlstr+='<button type="button" id="append" onClick="if (getElementById(\'append\').innerHTML==Apend)'
htmlstr+=' {getElementById(\'append\').innerHTML=noApend} else {getElementById(\'append\').innerHTML=Apend}" >'
htmlstr+=Apend+'</button>'
*/
//htmlstr+='<br><input type="submit" value="Calculate" onClick="timerStart();setTimeout(\'calculateStats()\',100);return false;"  name="calc" id="calc">';
