...
fe+='<div id="tab1" class="tab"  style="position:absolute; left:'+'0;"'+'onClick = "showPanel(1);" onMouseOver="hover(this);" onMouseOut="setState(1)">'
fe+=t('Start')
fe+='</div>'
fe+='<div id="tab2" class="tab"  style="position:absolute; left:'+'18.5%;"'+'onClick = "showPanel(2);" onMouseOver="hover(this);" onMouseOut="setState(2);">'
//fe+="&nbsp;"
...
fe+=t('Enter')
fe+='</div>'
fe+='<div id="tab3" class="tab"  style="position:absolute; left:37%;"'+' onClick = "callStatsIf(); showPanel(3);" onMouseOver="hover(this);" onMouseOut="setState(3);">'
fe+=t('Results')
fe+='</div>'
fe+='<div id="tab4" class="tab"  style="position:absolute; left:'+'55.5%;"'+'onClick = "showPanel(4);showExWindow();" onMouseOver="hover(this);" onMouseOut="setState(4)">'
fe+=t('Examples')
fe+='</div>'
...
{
  fe+='<div id="tab5" class="tab" style="position:absolute; left: 74%;" onClick = "showPanel(5);" onMouseOver="hover(this);" onMouseOut="setState(5)">'
}
fe+=t("Help");
fe+='</div>'
