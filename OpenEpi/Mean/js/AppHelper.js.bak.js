...
fe+='<div id="menuDiv" name="menuDiv" style="width:240;" class="dtree">';
fe+='<script type="text/javascript" src="../js/OEMenu.js"></script>';
fe+='</div>';
var tabWidth=20;
if (device!="smartphone")
{
...
if (device=="smartphone")
 {fe+='<div id="appDiv" name="appDiv" style="position:absolute; left-margin:5px;">'}
else
 {fe+='<div id="appDiv" name="appDiv" style="position:absolute; top:5px; left:250px;">'}

fe+='<div id="tab1" class="tab" style="position:absolute; left: 18%;" onClick = "showPanel(1);" onMouseOver="hover(this);" onMouseOut="setState(1)">'
fe+=t('Start')
fe+='</div>'
fe+='<div id="tab2" class="tab" style="position:absolute; left: 34%; width:20%; top:0;" onClick = "if (OpenEpi==false){useOpenEpiEntry()};showPanel(2);" onMouseOver="hover(this);" onMouseOut="setState(2);">'
fe+=t('Enter')
fe+='</div>'
fe+='<div id="tab3" class="tab" style="position:absolute;left: 50%;" onClick = "callStatsIf(); showPanel(3);" onMouseOver="hover(this);" onMouseOut="setState(3);">'
fe+=t('Results')
fe+='</div>'
fe+='<div id="tab4" class="tab" style="position:absolute;left: 66%;" onClick = "showPanel(4);showExWindow();" onMouseOver="hover(this);" onMouseOut="setState(4)">'
fe+=t('Examples')
fe+='</div>'
if (device=="smartphone")
{
//fe+='<td <div id="tab5" class="tab" style="left: 82%;" align="center" width="15%" bgcolor="#EEEEEE"><a onClick="writeToWin(document.body.innerHTML)" ><img src="../img/move.gif" width="20px" alt=t("Scroll")></a></td>';
  fe+='<td <div id="tab5" class="tab" style="left: 82%;" align="center" width="15%" bgcolor="#EEEEEE"><a onClick="showPanelAsWindow(currentPanel);" ><img src="../img/move.gif" width="10%" alt=t("Scroll")></a></td>';
}
else
{
...
fe+='    <td align="center" > <br /><input name="btnEnter" type="button" id="btnEnter" value="'+t("Enter New Data")+'" onClick="javascript:if (opener!=null){opener.useOpenEpiEntry();setTimeout(&quot;opener.useOpenEpiEntry()&quot;,200);self.close();} else {useOpenEpiEntry();setTimeout(&quot;useOpenEpiEntry()&quot;,200);}return false;"';
...
if ((demofile.length>0) && (device!="smartphone"))
  {
    ...
    {
      fe+='<table width=100% border="3" cellspacing="0" cellpadding="0">'
    }
    fe+='<tr>'
