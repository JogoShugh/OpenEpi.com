...
if (device=="smartphone")
 {
   ...
   htmlstr+='/*<![CDATA[*/'
     htmlstr+='body,td {font-size:0.9em;}'
   htmlstr+='/*]]>*/'
   htmlstr+='</style>'
 }
...
if (device!="smartphone")
{
htmlstr+='<br><br><br><br><p>';
}
htmlstr+='<br><input type="submit" value="Calculate" onClick="timerStart();setTimeout(\'calculateStats()\',100);return false;"  name="calc" id="calc">';
if (device!="smartphone")
{
htmlstr+='</p><p>'
}
...
htmlstr+='<input type="submit" name="Clear" value="Clear" onClick="clearTable();return false;">';
if (device!="smartphone")
   {htmlstr+='</p></DIV>'; }
...
htmlstr+=' <a name="settinglink" href="Settings.htm" target="_self">'+"Settings"+'</a>'
if (device != "smartphone")
  {htmlstr+='<br>'; }
else
  {htmlstr+='&nbsp;&nbsp;'}  
...
if (device!="smartphone")
{
  htmlstr+='<span id="scontrols_span" style="visibility:hidden; position:absolute;top:20;left:200">';
}
else
{
  htmlstr+='<br /><span id="scontrols_span" style="visibility:hidden; position:absolute;top:50;left:3">';
}

htmlstr+='<FORM NAME=form1>';
htmlstr+='<table name=scontrols id=scontrols style="position:relative; top:0;left:0">';
//Above had a colon after relative. Changed 7/27/2004
htmlstr+='<tr>';
htmlstr+='<td>';
